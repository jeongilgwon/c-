// 20221201_jik_test1.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    ...
    for (i = 0; i < 10; i++)
    {
        ...
        {
            printf("입력된 숫자의 값이 랜덤값보다 작습니다.\n");
        }
        else if (random_number < input)
        {
            printf("입력된 숫자의 값이 랜덤값보다 큽니다.\n");
        }
        else
        {
            printf("입력된 숫자의 값이 랜덤 숫자와 같습니다.\n");
        }
    }
