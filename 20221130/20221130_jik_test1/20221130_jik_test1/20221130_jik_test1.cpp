// 20221130_jik_test1.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    ...
    printf("max : %6.3lf\n", max_d);
    if ((dist1 == min_d) || (dist1 == max_d)) && ((dist2 == min_d) || (dist2 == max_d))
    {
        printf("중간값은 %d\n", a);
    }
    if ((dist1 == min_d) || (dist1 == max_d)) && ((dist3 == min_d) || (dis3 == max_d))
    {
        printf("중간값은 %d\n", b);
    }
    if ((dist2 == min_d) || (dist2 == max_d)) && ((dist3 == min_d) || (dist3 == max_d))
    {
        printf("중간값은 %d\n", c);
    }
    return 0;
